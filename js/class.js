class Animal {
  constructor(id, imagen, nombre, descripcion, tipo, raza, estado, genero, edad, tamano, peso) {
    /**
     * Se controla en imagen, nombre, descripcion, tipo, raza, estado, genero y tamano si son cadena vacia o de tipo numero.
     */
    if (imagen.length === 0) {
